...
<head>
  ...
  <body class="bg-light-gray" id="body">
            ...
            <div class="card-header bg-primary">
              <div class="app-brand">
                <a href="/index.html">
                  ...
                  <span class="brand-name">POS Dashboard</span>
                </a>
              </div>
            </div>
      ...
      <div class="copyright pl-0">
        <p class="text-center">&copy; 2018 Copyright Projectpos Dashboard 
          <a class="text-primary" href="http://www.iamabdus.com/" target="_blank">Project</a>.
        </p>
      </div>
    </div>
</body>
